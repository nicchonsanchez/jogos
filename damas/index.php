...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .color-opt,.diff-btn{flex:1;padding:7px;background:#08080f;border:1px solid #1e1e30;border-radius:5px;color:#555;font-size:.78rem;cursor:pointer;text-align:center;transition:all .12s;font-family:inherit}
