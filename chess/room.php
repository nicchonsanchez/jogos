...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    /* ── Waiting ── */
    .room-code{font-size:2.8rem;font-weight:900;letter-spacing:8px;color:#f59e0b;text-shadow:0 0 30px #f59e0b55;background:#0e0e1e;border:1px solid #f59e0b33;border-radius:10px;padding:16px 32px}
    ...
    .btn-primary{background:var(--c);color:#080812;margin-top:4px}
    ...
    .promo-box{background:#10101e;border:1px solid #2a2a48;border-radius:10px;padding:24px;display:flex;flex-direction:column;align-items:center;gap:14px}
    .promo-box h3{color:#f59e0b;font-size:.9rem;letter-spacing:1px}
    .promo-pieces{display:flex;gap:10px}
    .promo-piece{width:60px;height:60px;background:#0a0a16;border:1px solid #1e1e38;border-radius:8px;font-size:2rem;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:border-color .12s}
