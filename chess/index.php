...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .color-opt{flex:1;padding:7px;background:#060712;border:1px solid #1c2035;border-radius:5px;color:#555;font-size:.78rem;cursor:pointer;text-align:center;transition:all .12s;font-family:inherit}
    ...
    .btn-primary{background:var(--c);color:#060712}
    ...
    .diff-btn{flex:1;padding:7px;background:#060712;border:1px solid #1c2035;border-radius:5px;color:#555;font-size:.78rem;cursor:pointer;text-align:center;transition:all .12s;font-family:inherit}
