...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .form-box{background:#0b0d1e;border:1px solid #181b30;border-radius:10px;padding:20px;flex-direction:column;gap:14px}
    ...
    .bot-btn{flex:1;padding:8px 4px;background:#060712;border:1px solid #1c2035;border-radius:5px;color:#555;font-size:.8rem;cursor:pointer;text-align:center;transition:all .12s;font-family:inherit}
  ...
  <section id="create-section" style="display:none">
    ...
    <div class="form-box open">
      <div class="form-row">
        ...
        <small style="color:#2e3255;font-size:.68rem;margin-top:4px">Slots vazios serão preenchidos por bots ao iniciar</small>
      </div>
